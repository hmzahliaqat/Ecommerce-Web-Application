<template>
   ...
   <form method="post" enctype="multipart/form-data"  @submit.prevent="addProduct()">
                       <div class="container-fluid">
                           ...
                           <div class="row mb-4">
                               <div class="col text-end">
                                   <button @submit="" style="margin-top: 2px;" id="save"  class=" btn btn-success"> <i style="margin-bottom: 1px;" data-feather='save'></i>

                                <span class="add-to-cart"></span>   Save
...
closeButton: true,
   ...
   getCategory(){
       ...
       axios.get('/categoryItem').then(res=>{
